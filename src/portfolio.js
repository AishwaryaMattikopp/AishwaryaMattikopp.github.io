...
const greeting = {
  ...
  subTitle: emoji(
    "A passionate and versatile Engineer 🚀 with experience building scalable data pipelines, developing software solutions, and processing large datasets. Skilled in Python, with hands-on expertise in tools like Apache Spark, Hadoop, SQL, and cloud technologies, to create impactful, data-driven applications and derive actionable insights."
  ),
  resumeLink:
  ...
  schools: [
    {
      ...
      grade: "4/4",
      desc: "Took courses on Machine learning, Databases(Cassandra, MongoDB, Redis), Data Engineering, Data Warehosuing, Business Analytics, Data Visualization, Distributed Systems, Big Data Processing, and Cloud Computing... contributed to 2 publications on data analytics and pipeline optimization.",
    },
    {
